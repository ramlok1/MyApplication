 ...
 */
public class ListAdapter_Cupones_encuesta extends ArrayAdapter<Entity_CuponesHoja> {
    Entity_CuponesHoja p;
    View v;

    private List<Entity_CuponesHoja> lista;

    public ListAdapter_Cupones_encuesta(Context context, int textViewResourceId) {
        super(context, textViewResourceId);
    }

    public ListAdapter_Cupones_encuesta(Context context, int resource, List<Entity_CuponesHoja> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (v == null) {
            ...
            v = vi.inflate(R.layout.cupones_encuesta, null);
        }
